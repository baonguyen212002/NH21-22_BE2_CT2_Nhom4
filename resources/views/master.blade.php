...
<link rel="stylesheet" type="{{ asset('text/css" href="styles/contact_styles.css')}}">
<link rel="stylesheet" type="{{ asset('text/css" href="styles/contact_responsive.css')}}">
</head>
	...
	<div class="hamburger_menu">
		...
		<div class="hamburger_menu_content text-right">
			<ul class="menu_top_nav">
				...
				<li class="menu_item"><a href="{{ url('index')}}">home</a></li>
				<li class="menu_item"><a href="{{ url('categories')}}">shop</a></li>
				<li class="menu_item"><a href="{{ url('contact')}}">promotion</a></li>
				<li class="menu_item"><a href="{{ url('single')}}">single</a></li>
